  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-4 right-4 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#30BEFF] border border-white/30"
        aria-label="Botão flutuante de WhatsApp para contato"
      >
        <div className="absolute z-10 top-0 left-0 w-full h-full rounded-full bg-[#30BEFF] animate-ping border border-white"></div>
